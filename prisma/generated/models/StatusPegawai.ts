...
// @ts-nocheck 
/*
 * This file exports the `StatusPegawai` model and its related types.
 *
...
export type GetStatusPegawaiAggregateType<T extends StatusPegawaiAggregateArgs> = {
      [P in keyof T & keyof AggregateStatusPegawai]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateStatusPegawai[P]>
    : Prisma.GetScalarType<T[P], AggregateStatusPegawai[P]>
}
...
type GetStatusPegawaiGroupByPayload<T extends StatusPegawaiGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<StatusPegawaiGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof StatusPegawaiGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], StatusPegawaiGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], StatusPegawaiGroupByOutputType[P]>
      }
    >
  >
...
export type StatusPegawaiWhereInput = {
  ...
  nama?: Prisma.StringFilter<"StatusPegawai"> | string
  description?: Prisma.StringFilter<"StatusPegawai"> | string
  isSync?: Prisma.BoolFilter<"StatusPegawai"> | boolean
...
export type StatusPegawaiScalarWhereWithAggregatesInput = {
  ...
  nama?: Prisma.StringWithAggregatesFilter<"StatusPegawai"> | string
  description?: Prisma.StringWithAggregatesFilter<"StatusPegawai"> | string
  isSync?: Prisma.BoolWithAggregatesFilter<"StatusPegawai"> | boolean
}
...
export type StatusPegawaiCreateInput = {
  ...
  description: string
  isSync: boolean
  pegawai?: Prisma.PegawaiCreateNestedManyWithoutStatusPegawaiInput
}
...
export type StatusPegawaiUncheckedCreateInput = {
  ...
  description: string
  isSync: boolean
  pegawai?: Prisma.PegawaiUncheckedCreateNestedManyWithoutStatusPegawaiInput
}
...
export type StatusPegawaiUpdateInput = {
  ...
  pegawai?: Prisma.PegawaiUpdateManyWithoutStatusPegawaiNestedInput
}
...
export type StatusPegawaiUncheckedUpdateInput = {
  ...
  description?: Prisma.StringFieldUpdateOperationsInput | string
  isSync?: Prisma.BoolFieldUpdateOperationsInput | boolean
  pegawai?: Prisma.PegawaiUncheckedUpdateManyWithoutStatusPegawaiNestedInput
}
...
export type StatusPegawaiScalarRelationFilter = {
  is?: Prisma.StatusPegawaiWhereInput
  isNot?: Prisma.StatusPegawaiWhereInput
}
...
export type StatusPegawaiUpdateOneRequiredWithoutPegawaiNestedInput = {
  create?: Prisma.XOR<Prisma.StatusPegawaiCreateWithoutPegawaiInput, Prisma.StatusPegawaiUncheckedCreateWithoutPegawaiInput>
  connectOrCreate?: Prisma.StatusPegawaiCreateOrConnectWithoutPegawaiInput
...
export type StatusPegawaiOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "nama" | "description" | "isSync", ExtArgs["result"]["statusPegawai"]>
...
export type StatusPegawaiCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<StatusPegawaiFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface StatusPegawaiDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['StatusPegawai'], meta: { name: 'StatusPegawai' } }
  /**
   ...
   * })
  **/
  count<T extends StatusPegawaiCountArgs>(
    args?: Prisma.Subset<T, StatusPegawaiCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], StatusPegawaiCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends StatusPegawaiGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, StatusPegawaiGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetStatusPegawaiGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
...
export interface StatusPegawaiFieldRefs {
  ...
  readonly nama: Prisma.FieldRef<"StatusPegawai", 'String'>
  readonly description: Prisma.FieldRef<"StatusPegawai", 'String'>
  readonly isSync: Prisma.FieldRef<"StatusPegawai", 'Boolean'>
}
